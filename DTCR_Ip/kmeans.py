...
class kmeans():
    def __init__(self, opts):
        ...
        # self.training_batch_samples = opts['training_batch_samples']
        ...
        self.F = tf.Variable(tf.random_normal(shape=(opts['batch_size'], self.cluster_num),mean=0,stddev=0.1), name='kmeans_F', dtype=tf.float32)
